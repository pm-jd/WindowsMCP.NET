...
public static class SnapshotTools
{
    ...
    [Description("Capture screenshot and build numbered UI element tree for label-based interaction.")]
    ...
    [Description("Fast screenshot using cached UI element labels.")]
